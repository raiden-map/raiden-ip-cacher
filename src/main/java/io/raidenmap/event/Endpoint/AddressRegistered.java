...
public class AddressRegistered extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7157469612334613304L;
  ...
  @Deprecated public io.raidenmap.event.Endpoint.metadata metadata;
   ...
   */
  public AddressRegistered(java.lang.CharSequence endpointAddress, java.lang.CharSequence ethAddress, io.raidenmap.event.Endpoint.metadata metadata) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: metadata = (io.raidenmap.event.Endpoint.metadata)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public io.raidenmap.event.Endpoint.metadata getMetadata() {
    return metadata;
  }
   ...
   * @param value the value to set.
   */
  public void setMetadata(io.raidenmap.event.Endpoint.metadata value) {
    this.metadata = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AddressRegistered>
    ...
    private io.raidenmap.event.Endpoint.metadata metadata;
    private io.raidenmap.event.Endpoint.metadata.Builder metadataBuilder;
    ...
    private Builder(io.raidenmap.event.Endpoint.AddressRegistered.Builder other) {
      ...
      if (other.hasMetadataBuilder()) {
        this.metadataBuilder = io.raidenmap.event.Endpoint.metadata.newBuilder(other.getMetadataBuilder());
      }
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public io.raidenmap.event.Endpoint.AddressRegistered.Builder setEndpointAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.raidenmap.event.Endpoint.AddressRegistered.Builder setEthAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.raidenmap.event.Endpoint.AddressRegistered.Builder setMetadata(io.raidenmap.event.Endpoint.metadata value) {
     ...
     * @return This builder.
     */
    public io.raidenmap.event.Endpoint.metadata.Builder getMetadataBuilder() {
      if (metadataBuilder == null) {
        if (hasMetadata()) {
          setMetadataBuilder(io.raidenmap.event.Endpoint.metadata.newBuilder(metadata));
        } else {
          setMetadataBuilder(io.raidenmap.event.Endpoint.metadata.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public io.raidenmap.event.Endpoint.AddressRegistered.Builder setMetadataBuilder(io.raidenmap.event.Endpoint.metadata.Builder value) {
      clearMetadata();
    ...
    public AddressRegistered build() {
      try {
        ...
        if (metadataBuilder != null) {
          ...
          record.metadata = fieldSetFlags()[2] ? this.metadata : (io.raidenmap.event.Endpoint.metadata) defaultValue(fields()[2]);
        }
        return record;
