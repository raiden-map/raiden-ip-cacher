...
public class metadata extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8743575020359497573L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"metadata\",\"namespace\":\"io.raidenmap.event.Endpoint\",\"fields\":[{\"name\":\"blockNumber\",\"type\":\"long\"},{\"name\":\"blockTimestamp\",\"type\":\"long\"},{\"name\":\"eventTimestamp\",\"type\":\"long\"}]}");
   ...
   */
  public static io.raidenmap.event.Endpoint.metadata.Builder newBuilder() {
    return new io.raidenmap.event.Endpoint.metadata.Builder();
  }
   ...
   * @return A new metadata RecordBuilder
   */
  public static io.raidenmap.event.Endpoint.metadata.Builder newBuilder(io.raidenmap.event.Endpoint.metadata.Builder other) {
    return new io.raidenmap.event.Endpoint.metadata.Builder(other);
  }
   ...
   * @return A new metadata RecordBuilder
   */
  public static io.raidenmap.event.Endpoint.metadata.Builder newBuilder(io.raidenmap.event.Endpoint.metadata other) {
    return new io.raidenmap.event.Endpoint.metadata.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<metadata>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.raidenmap.event.Endpoint.metadata.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.raidenmap.event.Endpoint.metadata other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.blockNumber)) {
        this.blockNumber = data().deepCopy(fields()[0].schema(), other.blockNumber);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.raidenmap.event.Endpoint.metadata.Builder setBlockNumber(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.raidenmap.event.Endpoint.metadata.Builder clearBlockNumber() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.raidenmap.event.Endpoint.metadata.Builder setBlockTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.raidenmap.event.Endpoint.metadata.Builder clearBlockTimestamp() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.raidenmap.event.Endpoint.metadata.Builder setEventTimestamp(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.raidenmap.event.Endpoint.metadata.Builder clearEventTimestamp() {
